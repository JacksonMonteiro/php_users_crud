...
<body>
	<header class="deep-purple lighten-1">
    	<h1 class="white-text">Delete User</h1>
    </header>
	...
	<div class="row flex" id="add-user-form">
		<form action="delete_user.php" method="POST" class="col s11">
			...
			<input type="submit" value="Delete user" class="btn red button"> <a href="index.php" class="btn deep-purple lighten-1 button">Users list</a>
		</form>
	</div>
</body>
</html>